...
<div class="container mt-5">
  ...
  <section class="dark-grey-text">
    ...
    <!-- Section heading -->
    <h5 class="text-left font-weight-bold mb-4 pb-2">Upcoming Events</h5>
    <!-- Section description -->
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-7 col-xl-8">
        ...
        <!-- Post title -->
        <h4 class="font-weight-bold mb-3"><strong><a href="<?=BASE_URL.'webinar-details/'?>">Title of the Event</a></strong></h4>
        <!-- Excerpt -->
        ...
        <!-- Read more button -->
        <a href="<?=BASE_URL.'webinar-details/'?>" class="btn btn-primary btn-md mx-0 btn-rounded">Read more</a>
